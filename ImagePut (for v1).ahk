...
class ImagePut {
   ...
   webp(pStream, ByRef pDelays, ByRef pCount) {
   ...
   BitmapToWindow(pBitmap, title := "", pos := "", style := 0x82C80000, styleEx := 0x9, parent := "", playback := "") {
