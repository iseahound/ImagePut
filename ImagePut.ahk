...
class ImagePut {
   ...
   static call(cotype, image, p*) {
      ...
      if IsObject(image) {
         ...
         ForcePushImageToMemory := this.ForcePushImageToMemory ? true : ObjHasOwnProp(image, "ForcePushImageToMemory") ? image.ForcePushImageToMemory : false
